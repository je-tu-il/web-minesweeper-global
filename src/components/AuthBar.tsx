...
import { Bomb, LogOut, Shield } from "lucide-react";
  ...
  return (
    <header className="mb-4 flex items-center justify-between rounded-2xl border border-white/10 bg-white/[0.04] px-5 py-3 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="grid h-9 w-9 place-items-center rounded-full bg-gradient-to-br from-cyan-400 to-blue-500 text-sm font-bold text-white">
          {initial}
        </div>
